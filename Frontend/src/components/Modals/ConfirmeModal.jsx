...
const ConfirmReservationModal = ({close}) => {
  ...
  return (
    <div className="fixed inset-0 bg-[rgba(0,0,0,0.4)] h-full w-full flex items-center justify-center">
      <div className="max-w-[95%] shadow-lg bg-white space-y-2.5 ">
        <h2 className="p-5 font-bold text-white text-2xl bg-primary">Confimar Cancelamento</h2>
        <div className="p-4 pt-0 space-y-3">
          ...
          <div className="mt-4 flex items-center justify-end gap-3 font-[500]">
            ...
            <button onClick={() => handlerEdit()} className="p-3 flex text-white items-center gap-1 rounded cursor-pointer bg-primary hover:bg-primary-dark">
              <Check size={18}/>
              Confirmar reserva
            </button>
          </div>
