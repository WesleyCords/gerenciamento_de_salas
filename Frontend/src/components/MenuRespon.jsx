import {Menu, X, LayoutDashboard, DoorOpen, CalendarCheck} from 'lucide-react'
    ...
    return (
        <div className='w-full sm:hidden'>
            <div className="bg-primary w-full h-[50px] flex px-4 gap-4 items-center">
                <button onClick={() => setIsOpen(!isOpen)} aria-label={isOpen ? "Fechar menu" : "Abrir menu"}>
                    {isOpen ? <X className='text-principal' /> : <Menu className='text-principal' />}
                </button>
