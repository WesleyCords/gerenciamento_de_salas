  ...
  const eyesIcon = () => {
    return (
      <i
        ...
        className={`fa-regular text-primary-light cursor-pointer ${isView ? "fa-eye-slash" : "fa-eye"}`}
      ></i>
    );
  };
      ...
      <div className="bg-primary relative z-0 hidden md:block">
        ...
        <div className="relative z-20 flex flex-col items-center p-5 text-center gap-6">
          ...
          <p className="font-semibold text-white text-2xl">
            Protegemos seus dados com criptografia avançada e as melhores
            práticas de segurança do mercado. Sua privacidade é nossa
            prioridade.
          </p>
        </div>
      </div>
      <div className="bg-secundary flex items-center justify-center">
        <div className="bg-principal shadow py-4 rounded-2xl flex flex-col items-center gap-3 w-[95%] md:w-[60%]">
          ...
          <form className="md:w-[85%] space-y-3" onSubmit={createAccount}>
            <div>
              <label htmlFor="nome" className="text-text-secundary">
                Nome
              </label>
              <div className="py-1 px-4 group border-[1.5px] rounded border-black focus-within:border-primary">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setCredenciais({ ...credenciais, nome: e.target.value })
                  }
                />
              </div>
            </div>
            <div>
              <label htmlFor="email" className="text-text-secundary">
                E-mail
              </label>
              <div className="py-1 px-4 group border-[1.5px] rounded border-black focus-within:border-primary">
            ...
            <div>
              <label htmlFor="password" className="text-text-secundary">
                Senha
              </label>
              <div
                className={`flex items-center gap-3 py-1 px-4 group border-[1.5px] rounded ${passwordConflit ? "border-red-600 bg-red-100" : "border-black"} focus-within:border-primary`}
              >
            ...
            <div>
              <label htmlFor="password2" className="text-text-secundary">
                Confirme sua senha
              </label>
              <div
                className={`flex items-center gap-3 py-1 px-4 group border-[1.5px] rounded ${passwordConflit ? "border-red-600 bg-red-100" : "border-black"} focus-within:border-primary`}
            ...
            <button
              disabled={loading}
              className="bg-primary font-bold transition-all duration-150 text-white rounded hover:bg-primary-dark py-3 text-center w-full cursor-pointer mt-3 hover:-translate-y-1"
            >
          ...
          <div className="border-t-[1.5px] border-gray-300 w-[85%] text-center">
            <h3 className="my-2 ">
              ...
              <span
                ...
                className="ml-2 hover:underline cursor-pointer font-semibold text-primary"
              >
                Faça o login
              </span>
            </h3>
